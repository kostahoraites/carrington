...
srun python /proj/horakons/analysator/tools/vlsvintpol.py -i /wrk/group/spacephysics/vlasiator/3D/EGL/bulk/bulk1.egl.{STARTFILE..ENDFILE}.vlsv -var vg_rho vg_b_vol.magnitude proton/vg_precipitationdifferentialflux.6 -c /wrk-vakka/users/horakons/carrington/virtual_sc/txt_files/coords_grid.txt -re -n 64 > OUTFILE.txt
