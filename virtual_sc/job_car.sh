...
#egl
#mpirun python vlsvintpol_mpi.py -outfile txt_files/virtual_sc_data_btrace_egl.txt -i /wrk-vakka/group/spacephysics/vlasiator/3D/EGL/bulk/bulk1.egl.*.vlsv -var vg_e_vol.x vg_e_vol.y vg_e_vol.z vg_b_vol.x vg_b_vol.y vg_b_vol.z -c txt_files/coords_galaxy_15_btrace_egl.txt -re
