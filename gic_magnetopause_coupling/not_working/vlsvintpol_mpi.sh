...
#SBATCH --nodes=4
#SBATCH -n 256             # number of tasks (64xnodes)
##SBATCH --nodes=5
...
#egl
mpirun python vlsvintpol_mpi.py -outfile txt_files/data_FHAFGB_btrace.txt -i /wrk-vakka/group/spacephysics/vlasiator/3D/FHA/bulk1/bulk1.000{1100..1170}.vlsv -var vg_j.x -c txt_files/fg_innerboundary_btrace_FHAFGB.txt -re
